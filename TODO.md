...
7. ⬜ `sql/schema_shift_codes.sql` — **ยังไม่ได้รัน** ย้ายรหัสกะมาเก็บใน DB เพื่อให้เพิ่มกะใหม่ได้จากหน้าเว็บ (ถ้าไม่รัน ระบบยังใช้รหัสกะเริ่มต้นในโค้ดได้ แต่จะเพิ่มรหัสใหม่ไม่ได้)
